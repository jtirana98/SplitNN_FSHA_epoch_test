...
class FSHA:
    ...
    @tf.function
    def train_step(self, x_private, x_public, label_private, label_public, is_fsha):
    ...
    # EDWWWW
    def __call__(self, iterations, log_frequency=500, num_pretrains=500, verbose=False, progress_bar=True):
